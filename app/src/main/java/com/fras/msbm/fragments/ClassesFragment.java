...
/**
 * Created by Shane on 8/28/2016.
 */
public class ClassesFragment extends BaseFragment {
    public static final String TAG = ClassesFragment.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setToolbarTitle(getString(R.string.title_classes));
        setupLayouts();
    ...
    private Request buildLectureRequest(String url) {
        final RequestBody requestBody = new FormBody.Builder()
                .add("request_type", "classes").build();

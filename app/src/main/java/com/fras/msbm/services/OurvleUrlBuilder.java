 ...
 */
public class OurvleUrlBuilder extends MoodleUrlBuilder {

    public OurvleUrlBuilder(Context context) {
        super(context);
    }

    @Override
    public String getBaseUrl() {
        return context.getResources().getString(R.string.moodle_ourvle_base_url);
    }
